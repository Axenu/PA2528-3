...
//FAMesh* AssimpLoader::loadMeshFromFile(const std::string& objFile)
//{
//	aiMesh* aiMesh[2];
//	Mesh* mesh = new Mesh();
//
...
//	mesh->hasTextureCoords = m_scene->mMeshes[0]->HasTextureCoords(0);
//
//	FAMesh* faMesh = new FAMesh(mesh);
//
//	return faMesh;
//}
//
//FAMesh* AssimpLoader::loadMeshFromMemory(const void* buffer, size_t length, FileType fileType)
//{
//	aiMesh* aiMesh[2];
//	Mesh* mesh = new Mesh();
//
